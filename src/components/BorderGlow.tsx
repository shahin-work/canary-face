...
// Defaults themed to the Canary Face blue UI.
const BorderGlow = ({
  children,
  className = "",
  edgeSensitivity = 30,
  glowColor = "224 76 60",                       // indigo glow (hsl H S L)
  backgroundColor = "#0B1340",                   // SURF
  borderRadius = 16,
  glowRadius = 26,
  glowIntensity = 1.0,
  coneSpread = 25,
  animated = false,
  colors = ["#6366F1", "#60A5FA", "#22D3EE"],   // indigo → blue → cyan
  fillOpacity = 0.5,
  style,
}: BorderGlowProps) => {
